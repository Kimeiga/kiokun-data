-- Learning Resources Tables Only
-- This migration adds only the new Learning Resources tables
...
CREATE UNIQUE INDEX `language_categories_slug_unique` ON `language_categories` (`slug`);
--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `resource_sources_languageCategoryId_slug_unique` ON `resource_sources` (`languageCategoryId`,`slug`);
--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `video_posts_resourceSourceId_slug_unique` ON `video_posts` (`resourceSourceId`,`slug`);
--> statement-breakpoint
