...
TARGETED_MNEMONIC_OVERRIDES: dict[str, str | dict[str, Any]] = {
    ...
    "方": "A 刀 knife set against 一 one line points in a clear 方 direction.",
    ...
    "武": "A 弋 bladeless halberd, 一 one line, and 止 stop form a 武 military stance.",
    ...
    "刀": "The long blade and short handle cut the profile of 刀 knife.",
    ...
    "那": "A 刀 knife, 二 two lines, and a ⻏ city frame the far side as 那 that.",
