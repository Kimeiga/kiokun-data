#!/usr/bin/env python3
"""Test Japanese-specific Whisper model fine-tuned on ReazonSpeech data."""
...
def main():
    ...
    model_id = sys.argv[2] if len(sys.argv) > 2 else "japanese-asr/distil-whisper-large-v3-ja-reazonspeech-large"
    ...
    result = pipe(audio_path, return_timestamps=True, generate_kwargs={"language": "ja"})
